...
public class AdicionarRoupaGUI extends javax.swing.JFrame {

    private Object r;

    public AdicionarRoupaGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CADASTRAR ROUPA");
        ...
        marcaComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Adidas", "Nike", "SHEIN" }));
        ...
        materialComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Algodão", "Poliéster", "Jeans", "Seda", "Malha", "Veludo", "Linho", "Lã" }));
        ...
        corComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Preto", "Branco", "Cinza", "Marrom", "Azul", "Vermelho", "Amarelo", "Verde", "Laranja", "Roxo", "Rosa" }));
    ...
    private void salvarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarButtonActionPerformed
        ...
        if (codigoRefTxt.getText().isEmpty() || precoVendaTxt.getText().isEmpty() ||  
            ...
            int codigoRef = Integer.parseInt(codigoRefTxt.getText());
            double precoVenda = Double.parseDouble(precoVendaTxt.getText());
            double precoCusto = Double.parseDouble(precoCustoTxt.getText());
            String tamanho = tamanhoComboBox.getSelectedItem().toString();
            String tipo = tipoComboBox.getSelectedItem().toString();
            String marca = marcaComboBox.getSelectedItem().toString();
            String categoriaEtaria = categoriaEtariaComboBox.getSelectedItem().toString();
            String cor = corComboBox.getSelectedItem().toString();
            String genero = generoComboBox.getSelectedItem().toString();
            String material = materialComboBox.getSelectedItem().toString();
            int quantEstoque = Integer.parseInt(quantEstoqueTxt.getText());
            
            Roupa roupa = new Roupa(codigoRef, precoVenda, precoCusto, tamanho,
                    tipo, marca, categoriaEtaria, cor, genero, material, quantEstoque);
            int linhasAfetadasInsercaoRoupa = RoupaBD.inserirRoupa(roupa);
            if (linhasAfetadasInsercaoRoupa == 1) {
                RoupaGUI.adicionarRoupaNaTabela();
                JOptionPane.showMessageDialog(null, "Roupa adicionar com sucesso!");
                this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdicionarRoupaGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdicionarRoupaGUI().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JComboBox<Object> corComboBox;
    ...
    public static javax.swing.JComboBox<Object> marcaComboBox;
    public static javax.swing.JComboBox<Object> materialComboBox;
    ...
    public static javax.swing.JComboBox<Object> tipoComboBox;
