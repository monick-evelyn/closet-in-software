...
import view.funcionalidades.cliente.*;
...
public class AlterarClienteGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        refRoupaTxt = new javax.swing.JTextField();
        ...
        refRoupaTxt.setBackground(new java.awt.Color(51, 0, 51));
        refRoupaTxt.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        refRoupaTxt.setForeground(new java.awt.Color(255, 255, 255));
        refRoupaTxt.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                refRoupaTxtKeyTyped(evt);
            }
        });
        ...
        jLabel17.setText("Você não pode alterar o CPF!");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(refRoupaTxt, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(27, 27, 27)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void salvarJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarJButtonActionPerformed
        // TODO add your handling code here:
        if (nomeCompletoTxt.getText().isBlank() || cpfTxt.getText().isBlank() || telefoneTxt.getText().isEmpty() || dataNascimentoTxt.getText().isBlank() || refRoupaTxt.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Preencha os campos indicados com *, eles são obrigatórios.", 
                    "Atenção", JOptionPane.WARNING_MESSAGE);
        } else {
            Cliente cliente = ClienteBD.selecionarCliente((int)ClienteGUI.clientesJTable.getValueAt(ClienteGUI.clientesJTable.getSelectedRow(),1));
            cliente.setNomeCompleto(nomeCompletoTxt.getText());
            cliente.setEmail(emailTxt.getText());
            cliente.setGenero(generoComboBox.getSelectedItem().toString());
            cliente.setTelefone(Integer.parseInt(telefoneTxt.getText()));
            cliente.setDataDeNascimento(dataNascimentoTxt.getText());
            
            int refRoupa = Integer.parseInt(refRoupaTxt.getText());
            int fkIdRoupa = RoupaBD.pegarIdRoupa(refRoupa);
            cliente.setFkIdRoupa(fkIdRoupa);
            
            //COLAR COODIGO DE CRIAR E ADICIONAR CLIENTE
            int linhasAfetadasInsercao = ClienteBD.alterarDadosCliente(cliente);
    ...
    private void refRoupaTxtKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_refRoupaTxtKeyTyped
        // TODO add your handling code here:
        String caracteres = "0123456789";
        if (!caracteres.contains(evt.getKeyChar() + "")) {
            evt.consume(); //verificar carcateres digitados
        }
    }//GEN-LAST:event_refRoupaTxtKeyTyped
    ...
    public static javax.swing.JFormattedTextField cpfTxt;
    public static javax.swing.JFormattedTextField dataNascimentoTxt;
    ...
    public static javax.swing.JTextField nomeCompletoTxt;
    public static javax.swing.JTextField refRoupaTxt;
    private javax.swing.JButton salvarJButton;
    public static javax.swing.JFormattedTextField telefoneTxt;
