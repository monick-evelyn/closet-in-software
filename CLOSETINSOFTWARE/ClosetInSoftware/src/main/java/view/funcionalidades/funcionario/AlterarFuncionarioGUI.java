...
public class AlterarFuncionarioGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(nomeCompletoTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 60, 501, -1));
        ...
        jPanel1.add(cpfTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 110, 211, -1));
        ...
        jPanel1.add(crachaTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 110, 220, -1));
        ...
        jLabel10.setText("*");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 60, 16, -1));

        jLabel11.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("*");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 110, 16, -1));
        ...
        jLabel13.setText(" *");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 110, 16, -1));
        ...
        jLabel17.setText("Você não pode alterar o crachá!");
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 90, 170, 20));
    ...
    private void salvarJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarJButtonActionPerformed
        ...
        if (nomeCompletoTxt.getText().isBlank() || crachaTxt.getText().isEmpty() || 
            ...
            Funcionario funcionario = FuncionarioBD.selecionarFuncionario(
                    (int)FuncionarioGUI.funcionariosJTable.getValueAt(FuncionarioGUI.funcionariosJTable.getSelectedRow(),5)
            );
            
            funcionario.setNomeCompleto(nomeCompletoTxt.getText());
            funcionario.setEnderecoDeCracha(Integer.parseInt(crachaTxt.getText()));
            funcionario.setCpf(Integer.parseInt(cpfTxt.getText()));
            ...
            funcionario.setTelefone(Integer.parseInt(telefoneTxt.getText()));
            funcionario.setFuncao(funcaoComboBox.getSelectedItem().toString());

            int linhasAfetadas = FuncionarioBD.alterarDadosDoFuncionario(funcionario);
            if (linhasAfetadas == 1) {
    ...
    public static javax.swing.JTextField crachaTxt;
    public static javax.swing.JTextField emailTxt;
    private javax.swing.JButton fecharJButton;
    public static javax.swing.JComboBox<String> funcaoComboBox;
    ...
    public static javax.swing.JTextField salarioTxt;
    private javax.swing.JButton salvarJButton;
    public static javax.swing.JTextField senhaTxt;
